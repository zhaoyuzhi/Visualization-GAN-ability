# -*- coding: utf-8 -*-
"""
Created on Mon Jan  7 21:53:58 2019
...
os.makedirs('images_BEGAN', exist_ok=True)
...
for epoch in range(opt.n_epochs):
    for i, (imgs, _) in enumerate(dataloader):
        ...
        if batches_done % opt.sample_interval == 0:
            save_image(gen_imgs.data[:25], 'images_BEGAN/%d.png' % batches_done, nrow=5, normalize=True)
