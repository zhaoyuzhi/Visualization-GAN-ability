...
for epoch in range(opt.n_epochs):
    ...
    for i, (imgs, _) in enumerate(dataloader):
        ...
        # Adversarial loss
        # D(x) - D(G(z)) is the approximate Wasserstein Distance. We want to maximize it
        ...
        if batches_done % opt.sample_interval == 0:
            save_image(gen_imgs.data[:25], 'images_WGAN/%d.png' % batches_done, nrow=5, normalize=True)
        batches_done += 1